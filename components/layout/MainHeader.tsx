                            ...
                            {loading ? (
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    {isAdmin && (
                                        <Link
                                            href="/admin"
                                            className="px-4 h-10 flex items-center justify-center bg-yellow-600 text-white rounded font-bold hover:bg-yellow-700 text-sm transition-colors"
                                        >
                                            Admin
                                        </Link>
                                    )}
                                    ...
                                    <button
                                        ...
                                        className="px-4 h-10 bg-gray-700 text-white rounded font-bold hover:bg-red-600 text-sm transition-colors"
                                    >
                                        Çıkış
                                    </button>
                                </div>
                                ...
                                <div className="flex items-center gap-3">
                                    <Link
                                        href="/giris"
                                        className="flex items-center gap-2 px-6 h-10 bg-[#3b82f6] hover:bg-[#2563eb] text-white rounded font-bold text-sm transition-colors shadow-lg shadow-black-900/20"
                                    >
                                    ...
                                    <Link
                                        href="/bakiye-yukle"
                                        className="hidden lg:flex items-center gap-2 px-4 h-10 text-[#fac02e] hover:text-[#fbcd5a] font-bold text-sm transition-colors uppercase tracking-wider"
                                    >
                                        +BAKİYE YÜKLE
                                    </Link>
                                </div>
