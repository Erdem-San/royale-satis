...
export default function NavigationBarClient({ initialCategories }: NavigationBarClientProps) {
    ...
    return (
        <div className="hidden lg:block bg-[#252830] border-b border-[#1a1b1e] shadow-lg relative z-30">
            <div className="container mx-auto px-4">
                <nav className="flex items-center gap-1 overflow-x-auto no-scrollbar">
                    ...
                    <Link
                        href="/"
                        className={`ml-auto text-sm font-bold uppercase transition-colors tracking-wide text-green-500 hover:text-green-400`}
                    >
                        +BAKİYE YÜKLE
                    </Link>
                </nav>
