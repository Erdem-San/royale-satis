...
export default function EditBlogPostPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error(error.message || 'Blog yazısı güncellenirken bir hata oluştu');
        } finally {
            setProcessing(false);
        }
    };
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between gap-4 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="rounded-md bg-indigo-600 px-8 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 disabled:opacity-50 inline-flex items-center gap-2"
                        >
                            {processing ? (
                                <>
